        ...
        <footer className="bg-white">
            <div className="w-full  md:w-full p-4 py-6 lg:py-8">
                    ...
                    <div className="grid grid-cols-2 gap-10  sm:gap-24   sm:pl-6 sm:grid-cols-3">
                        {footerlinks.map(({ id, section, sectionlinks }) => (
                            <div key={id}>
                                ...
                                { section=="Links" &&
                                    <div className="flex mt-8 space-x-5  sm:mt-14">
                ...
                <div className="sm:flex sm:items-center sm:justify-between">
                    <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <a href="https://flowbite.com/" className="hover:underline">Pivotical</a>. All Rights Reserved.
                    </span>
                </div>
            </div>
        </footer>
